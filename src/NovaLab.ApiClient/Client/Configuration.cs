...
public class Configuration : IReadableConfiguration {
    ...
    public static IReadableConfiguration MergeConfigurations(IReadableConfiguration first, IReadableConfiguration second) {
        ...
        Dictionary<string, string> apiKey = first.ApiKey.ToDictionary(keySelector: kvp => kvp.Key, elementSelector: kvp => kvp.Value);
        Dictionary<string, string> apiKeyPrefix = first.ApiKeyPrefix.ToDictionary(keySelector: kvp => kvp.Key, elementSelector: kvp => kvp.Value);
        Dictionary<string, string> defaultHeaders = first.DefaultHeaders.ToDictionary(keySelector: kvp => kvp.Key, elementSelector: kvp => kvp.Value);
    ...
    public string GetOperationServerUrl(string operation, int index, Dictionary<string, string> inputVariables) {
        if (OperationServers.TryGetValue(operation, out List<IReadOnlyDictionary<string, object>>? operationServer)) {
