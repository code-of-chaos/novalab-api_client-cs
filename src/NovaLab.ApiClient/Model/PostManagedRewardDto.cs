...
namespace NovaLab.ApiClient.Model
{
    ...
    public partial class PostManagedRewardDto : IEquatable<PostManagedRewardDto>, IValidatableObject
    {
        ...
        public PostManagedRewardDto(CreateCustomRewardsRequest twitchApiRequest = default(CreateCustomRewardsRequest), string outputTemplatePerReward = default(string), string outputTemplatePerRedemption = default(string))
        {
