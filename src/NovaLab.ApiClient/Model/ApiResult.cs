...
public class ApiResult : IEquatable<ApiResult>, IValidatableObject {
    /// <summary>
    ...
    public ApiResult(HttpStatusCode? status = default, string message = default, List<object> data = default) {
        Status = status;
        Message = message;
        Data = data;
    }
    ...
    /// <returns>Boolean</returns>
    public override bool Equals(object input) => Equals(input as ApiResult);
