...
public class TwitchManagedRewardRedemptionDtoApiResult : IEquatable<TwitchManagedRewardRedemptionDtoApiResult>, IValidatableObject {
    /// <summary>
    ...
    public TwitchManagedRewardRedemptionDtoApiResult(HttpStatusCode? status = default, string message = default, List<TwitchManagedRewardRedemptionDto> data = default) {
        Status = status;
        Message = message;
        Data = data;
    }
    ...
    /// <returns>Boolean</returns>
    public override bool Equals(object input) => Equals(input as TwitchManagedRewardRedemptionDtoApiResult);
