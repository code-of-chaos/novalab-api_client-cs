...
namespace NovaLab.ApiClient.Model
{
    ...
    public partial class TwitchManagedRewardApiResult : IEquatable<TwitchManagedRewardApiResult>, IValidatableObject
    {
        ...
        public TwitchManagedRewardApiResult(HttpStatusCode? status = default(HttpStatusCode?), string message = default(string), List<TwitchManagedReward> data = default(List<TwitchManagedReward>))
        {
            this.Status = status;
        ...
        {
            return this.Equals(input as TwitchManagedRewardApiResult);
        }
